...
namespace Far.Data
{
	public class AccountTableGetUserLinksByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksByActiveStatus this[int row]
		public AccountRowGetUserLinksByActiveStatus this[int row] { get { return (AccountRowGetUserLinksByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
