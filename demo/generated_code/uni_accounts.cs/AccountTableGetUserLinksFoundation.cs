...
namespace Far.Data
{
	public class AccountTableGetUserLinksFoundation : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksFoundation(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksFoundation this[int row]
		public AccountRowGetUserLinksFoundation this[int row] { get { return (AccountRowGetUserLinksFoundation)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksFoundation : c.IDataRow
	{
		#region int Id
		public int Id
		{
