...
namespace Far.Data
{
	public class AccountTableGetWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetWithQueryP this[int row]
		public AccountRowGetWithQueryP this[int row] { get { return (AccountRowGetWithQueryP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
