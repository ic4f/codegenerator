...
namespace Far.Data
{
	public class AccountTableGetMasterAccountLinksWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetMasterAccountLinksWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetMasterAccountLinksWithQueryP this[int row]
		public AccountRowGetMasterAccountLinksWithQueryP this[int row] { get { return (AccountRowGetMasterAccountLinksWithQueryP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetMasterAccountLinksWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
