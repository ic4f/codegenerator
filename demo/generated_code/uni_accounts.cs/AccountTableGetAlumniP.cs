...
namespace Far.Data
{
	public class AccountTableGetAlumniP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetAlumniP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetAlumniP this[int row]
		public AccountRowGetAlumniP this[int row] { get { return (AccountRowGetAlumniP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetAlumniP : c.IDataRow
	{
		#region int Id
		public int Id
		{
