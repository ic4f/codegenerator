...
namespace Far.Data
{
	public class AccountTableGetUserLinksAlumniByActiveStatusP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksAlumniByActiveStatusP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksAlumniByActiveStatusP this[int row]
		public AccountRowGetUserLinksAlumniByActiveStatusP this[int row] { get { return (AccountRowGetUserLinksAlumniByActiveStatusP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksAlumniByActiveStatusP : c.IDataRow
	{
		#region int Id
		public int Id
		{
