...
namespace Far.Data
{
	public class UserTableGetRoleLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetRoleLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetRoleLinksWithQuery this[int row]
		public UserRowGetRoleLinksWithQuery this[int row] { get { return (UserRowGetRoleLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class UserRowGetRoleLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
