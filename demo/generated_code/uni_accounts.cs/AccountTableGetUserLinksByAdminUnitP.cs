...
namespace Far.Data
{
	public class AccountTableGetUserLinksByAdminUnitP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksByAdminUnitP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksByAdminUnitP this[int row]
		public AccountRowGetUserLinksByAdminUnitP this[int row] { get { return (AccountRowGetUserLinksByAdminUnitP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksByAdminUnitP : c.IDataRow
	{
		#region int Id
		public int Id
		{
