...
namespace Far.Data
{
	public class AccountTableGetUserLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksWithQuery this[int row]
		public AccountRowGetUserLinksWithQuery this[int row] { get { return (AccountRowGetUserLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
