...
namespace Far.Data
{
	public class AccountTableGetUserLinksFoundationByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksFoundationByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksFoundationByActiveStatus this[int row]
		public AccountRowGetUserLinksFoundationByActiveStatus this[int row] { get { return (AccountRowGetUserLinksFoundationByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksFoundationByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
