...
namespace Far.Data
{
	public class AccountTableGetUserLinksByAdminUnit : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksByAdminUnit(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksByAdminUnit this[int row]
		public AccountRowGetUserLinksByAdminUnit this[int row] { get { return (AccountRowGetUserLinksByAdminUnit)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksByAdminUnit : c.IDataRow
	{
		#region int Id
		public int Id
		{
