...
namespace Far.Data
{
	public class CollegeList : c.AbstractDataTable
	{
		...
		#region constructor 
		public CollegeList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region CollegeListRow this[int row]
		public CollegeListRow this[int row] { get { return (CollegeListRow)Rows[row]; } }
		#endregion
	...
	public class CollegeListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
