...
namespace Far.Data
{
	public class MasterAccountTableGetWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public MasterAccountTableGetWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region MasterAccountRowGetWithQueryP this[int row]
		public MasterAccountRowGetWithQueryP this[int row] { get { return (MasterAccountRowGetWithQueryP)Rows[row]; } }
		#endregion
	...
	public class MasterAccountRowGetWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
