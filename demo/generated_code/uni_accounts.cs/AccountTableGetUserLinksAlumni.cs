...
namespace Far.Data
{
	public class AccountTableGetUserLinksAlumni : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksAlumni(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksAlumni this[int row]
		public AccountRowGetUserLinksAlumni this[int row] { get { return (AccountRowGetUserLinksAlumni)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksAlumni : c.IDataRow
	{
		#region int Id
		public int Id
		{
