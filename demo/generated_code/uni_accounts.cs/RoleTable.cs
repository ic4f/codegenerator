...
namespace Far.Data
{
	public class RoleTable : c.AbstractDataTable
	{
		...
		#region constructor 
		public RoleTable(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region RoleRow this[int row]
		public RoleRow this[int row] { get { return (RoleRow)Rows[row]; } }
		#endregion
		...
		private class RankFieldClass : c.IDataField
		{
			...
			public string SortExpression { get { return "[Role].Rank"; } }
	...
	public class RoleRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
