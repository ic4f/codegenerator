...
namespace Far.Data
{
	public class AccountList : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountListRow this[int row]
		public AccountListRow this[int row] { get { return (AccountListRow)Rows[row]; } }
		#endregion
	...
	public class AccountListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
