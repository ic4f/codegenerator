...
namespace Far.Data
{
	public class UserTableGetRoleLinksWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetRoleLinksWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetRoleLinksWithQueryP this[int row]
		public UserRowGetRoleLinksWithQueryP this[int row] { get { return (UserRowGetRoleLinksWithQueryP)Rows[row]; } }
		#endregion
	...
	public class UserRowGetRoleLinksWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
