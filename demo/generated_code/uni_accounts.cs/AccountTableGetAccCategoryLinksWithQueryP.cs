...
namespace Far.Data
{
	public class AccountTableGetAccCategoryLinksWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetAccCategoryLinksWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetAccCategoryLinksWithQueryP this[int row]
		public AccountRowGetAccCategoryLinksWithQueryP this[int row] { get { return (AccountRowGetAccCategoryLinksWithQueryP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetAccCategoryLinksWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
