...
namespace Far.Data
{
	public class AccountTableGetByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetByActiveStatus this[int row]
		public AccountRowGetByActiveStatus this[int row] { get { return (AccountRowGetByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
