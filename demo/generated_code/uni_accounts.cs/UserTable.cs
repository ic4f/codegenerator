...
namespace Far.Data
{
	public class UserTable : c.AbstractDataTable
	{
		...
		#region static IDataField CampusCodeField 
		public static c.IDataField CampusCodeField { get { return new CampusCodeFieldClass(); } }
		#endregion

		#region static IDataField UniIdField 
		public static c.IDataField UniIdField { get { return new UniIdFieldClass(); } }
		#endregion

		#region static IDataField ConAgreeField 
		public static c.IDataField ConAgreeField { get { return new ConAgreeFieldClass(); } }
		#endregion

		#region static IDataField OnlineAccessField 
		public static c.IDataField OnlineAccessField { get { return new OnlineAccessFieldClass(); } }
		#endregion
		...
		private class CampusCodeFieldClass : c.IDataField
		{
			public string DataField { get { return "CampusCode"; } }
			public string SortExpression { get { return "[User].CampusCode"; } }
			public string Display { get { return "Campus Code"; } }
		}

		private class UniIdFieldClass : c.IDataField
		{
			public string DataField { get { return "UniId"; } }
			public string SortExpression { get { return "[User].UniId"; } }
			public string Display { get { return "UNI ID"; } }
		}

		private class ConAgreeFieldClass : c.IDataField
		{
			public string DataField { get { return "ConAgree"; } }
			public string SortExpression { get { return "[User].ConAgree"; } }
			public string Display { get { return "Confidentiality Agreement"; } }
		}

		private class OnlineAccessFieldClass : c.IDataField
		{
			public string DataField { get { return "OnlineAccess"; } }
			public string SortExpression { get { return "[User].OnlineAccess"; } }
