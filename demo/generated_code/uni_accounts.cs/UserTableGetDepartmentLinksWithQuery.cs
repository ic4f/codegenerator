...
namespace Far.Data
{
	public class UserTableGetDepartmentLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetDepartmentLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetDepartmentLinksWithQuery this[int row]
		public UserRowGetDepartmentLinksWithQuery this[int row] { get { return (UserRowGetDepartmentLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class UserRowGetDepartmentLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
