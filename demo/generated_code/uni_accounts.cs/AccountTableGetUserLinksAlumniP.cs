...
namespace Far.Data
{
	public class AccountTableGetUserLinksAlumniP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksAlumniP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksAlumniP this[int row]
		public AccountRowGetUserLinksAlumniP this[int row] { get { return (AccountRowGetUserLinksAlumniP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksAlumniP : c.IDataRow
	{
		#region int Id
		public int Id
		{
