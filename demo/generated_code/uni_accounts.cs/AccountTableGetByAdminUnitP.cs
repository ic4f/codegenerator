...
namespace Far.Data
{
	public class AccountTableGetByAdminUnitP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetByAdminUnitP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetByAdminUnitP this[int row]
		public AccountRowGetByAdminUnitP this[int row] { get { return (AccountRowGetByAdminUnitP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetByAdminUnitP : c.IDataRow
	{
		#region int Id
		public int Id
		{
