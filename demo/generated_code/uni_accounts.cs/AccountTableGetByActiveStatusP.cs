...
namespace Far.Data
{
	public class AccountTableGetByActiveStatusP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetByActiveStatusP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetByActiveStatusP this[int row]
		public AccountRowGetByActiveStatusP this[int row] { get { return (AccountRowGetByActiveStatusP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetByActiveStatusP : c.IDataRow
	{
		#region int Id
		public int Id
		{
