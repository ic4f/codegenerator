...
namespace Far.Data
{
	public class AccountTableGetFoundation : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetFoundation(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetFoundation this[int row]
		public AccountRowGetFoundation this[int row] { get { return (AccountRowGetFoundation)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetFoundation : c.IDataRow
	{
		#region int Id
		public int Id
		{
