...
namespace Far.Data
{
	public class AccountSummaryList : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountSummaryList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountSummaryListRow this[int row]
		public AccountSummaryListRow this[int row] { get { return (AccountSummaryListRow)Rows[row]; } }
		#endregion
	...
	public class AccountSummaryListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
