...
namespace Far.Data
{
	public class UserTableGetAccountLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetAccountLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetAccountLinksWithQuery this[int row]
		public UserRowGetAccountLinksWithQuery this[int row] { get { return (UserRowGetAccountLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class UserRowGetAccountLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
