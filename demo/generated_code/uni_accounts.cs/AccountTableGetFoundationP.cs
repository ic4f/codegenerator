...
namespace Far.Data
{
	public class AccountTableGetFoundationP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetFoundationP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetFoundationP this[int row]
		public AccountRowGetFoundationP this[int row] { get { return (AccountRowGetFoundationP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetFoundationP : c.IDataRow
	{
		#region int Id
		public int Id
		{
