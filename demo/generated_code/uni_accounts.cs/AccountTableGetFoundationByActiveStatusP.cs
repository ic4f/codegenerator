...
namespace Far.Data
{
	public class AccountTableGetFoundationByActiveStatusP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetFoundationByActiveStatusP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetFoundationByActiveStatusP this[int row]
		public AccountRowGetFoundationByActiveStatusP this[int row] { get { return (AccountRowGetFoundationByActiveStatusP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetFoundationByActiveStatusP : c.IDataRow
	{
		#region int Id
		public int Id
		{
