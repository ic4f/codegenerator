...
namespace Far.Data
{
	public class DepartmentList : c.AbstractDataTable
	{
		...
		#region constructor 
		public DepartmentList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region DepartmentListRow this[int row]
		public DepartmentListRow this[int row] { get { return (DepartmentListRow)Rows[row]; } }
		#endregion
	...
	public class DepartmentListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
