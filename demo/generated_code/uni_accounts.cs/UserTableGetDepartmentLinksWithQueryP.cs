...
namespace Far.Data
{
	public class UserTableGetDepartmentLinksWithQueryP : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetDepartmentLinksWithQueryP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetDepartmentLinksWithQueryP this[int row]
		public UserRowGetDepartmentLinksWithQueryP this[int row] { get { return (UserRowGetDepartmentLinksWithQueryP)Rows[row]; } }
		#endregion
	...
	public class UserRowGetDepartmentLinksWithQueryP : c.IDataRow
	{
		#region int Id
		public int Id
		{
