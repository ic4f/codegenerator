...
namespace Far.Data
{
	public class UserTableGetUserGroupLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserTableGetUserGroupLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserRowGetUserGroupLinksWithQuery this[int row]
		public UserRowGetUserGroupLinksWithQuery this[int row] { get { return (UserRowGetUserGroupLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class UserRowGetUserGroupLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
