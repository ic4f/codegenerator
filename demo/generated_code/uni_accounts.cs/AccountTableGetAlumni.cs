...
namespace Far.Data
{
	public class AccountTableGetAlumni : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetAlumni(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetAlumni this[int row]
		public AccountRowGetAlumni this[int row] { get { return (AccountRowGetAlumni)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetAlumni : c.IDataRow
	{
		#region int Id
		public int Id
		{
