...
namespace Far.Data
{
	public class AccountTableGetAccCategoryLinksWithQuery : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetAccCategoryLinksWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetAccCategoryLinksWithQuery this[int row]
		public AccountRowGetAccCategoryLinksWithQuery this[int row] { get { return (AccountRowGetAccCategoryLinksWithQuery)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetAccCategoryLinksWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
