...
namespace Far.Data
{
	public class AccountTableGetUserLinksAlumniByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksAlumniByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksAlumniByActiveStatus this[int row]
		public AccountRowGetUserLinksAlumniByActiveStatus this[int row] { get { return (AccountRowGetUserLinksAlumniByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksAlumniByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
