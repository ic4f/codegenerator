...
namespace Far.Data
{
	public class AccountTableGetUserLinksByActiveStatusP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksByActiveStatusP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksByActiveStatusP this[int row]
		public AccountRowGetUserLinksByActiveStatusP this[int row] { get { return (AccountRowGetUserLinksByActiveStatusP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksByActiveStatusP : c.IDataRow
	{
		#region int Id
		public int Id
		{
