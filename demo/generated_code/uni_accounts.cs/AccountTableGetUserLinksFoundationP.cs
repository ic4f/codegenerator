...
namespace Far.Data
{
	public class AccountTableGetUserLinksFoundationP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksFoundationP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksFoundationP this[int row]
		public AccountRowGetUserLinksFoundationP this[int row] { get { return (AccountRowGetUserLinksFoundationP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksFoundationP : c.IDataRow
	{
		#region int Id
		public int Id
		{
