...
namespace Far.Data
{
	public class UserLogTableGetRecordsByRoleP : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserLogTableGetRecordsByRoleP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserLogRowGetRecordsByRoleP this[int row]
		public UserLogRowGetRecordsByRoleP this[int row] { get { return (UserLogRowGetRecordsByRoleP)Rows[row]; } }
		#endregion
	...
	public class UserLogRowGetRecordsByRoleP : c.IDataRow
	{
		#region int Id
		public int Id
		{
