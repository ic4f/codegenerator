...
namespace Far.Data
{
	public class MasterAccountList : c.AbstractDataTable
	{
		...
		#region constructor 
		public MasterAccountList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region MasterAccountListRow this[int row]
		public MasterAccountListRow this[int row] { get { return (MasterAccountListRow)Rows[row]; } }
		#endregion
	...
	public class MasterAccountListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
