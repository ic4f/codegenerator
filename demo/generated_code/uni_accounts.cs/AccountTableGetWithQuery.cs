...
namespace Far.Data
{
	public class AccountTableGetWithQuery : c.AbstractDataTable
	{
		...
		#region static IDataField NumberAndDescriptionField 
		public static c.IDataField NumberAndDescriptionField { get { return new NumberAndDescriptionFieldClass(); } }
		#endregion
		...
		#region constructor 
		public AccountTableGetWithQuery(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetWithQuery this[int row]
		public AccountRowGetWithQuery this[int row] { get { return (AccountRowGetWithQuery)Rows[row]; } }
		#endregion
		...
		private class NumberAndDescriptionFieldClass : c.IDataField
		{
			public string DataField { get { return "NumberAndDescription"; } }
			public string SortExpression { get { return "AccountNumber"; } }
			public string Display { get { return "Number and Description"; } }
		}
	...
	public class AccountRowGetWithQuery : c.IDataRow
	{
		#region int Id
		public int Id
		{
		...
		#region string NumberAndDescription
		public string NumberAndDescription
		{
			get { return numberAndDescription; }
			set { numberAndDescription = value; }
		}
		#endregion
