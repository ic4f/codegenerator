...
namespace Far.Data
{
	public class AccountTableGetAlumniByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetAlumniByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetAlumniByActiveStatus this[int row]
		public AccountRowGetAlumniByActiveStatus this[int row] { get { return (AccountRowGetAlumniByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetAlumniByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
