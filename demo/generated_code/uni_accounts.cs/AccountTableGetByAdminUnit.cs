...
namespace Far.Data
{
	public class AccountTableGetByAdminUnit : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetByAdminUnit(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetByAdminUnit this[int row]
		public AccountRowGetByAdminUnit this[int row] { get { return (AccountRowGetByAdminUnit)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetByAdminUnit : c.IDataRow
	{
		#region int Id
		public int Id
		{
