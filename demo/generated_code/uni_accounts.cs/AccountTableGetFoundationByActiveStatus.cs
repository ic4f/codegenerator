...
namespace Far.Data
{
	public class AccountTableGetFoundationByActiveStatus : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetFoundationByActiveStatus(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetFoundationByActiveStatus this[int row]
		public AccountRowGetFoundationByActiveStatus this[int row] { get { return (AccountRowGetFoundationByActiveStatus)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetFoundationByActiveStatus : c.IDataRow
	{
		#region int Id
		public int Id
		{
