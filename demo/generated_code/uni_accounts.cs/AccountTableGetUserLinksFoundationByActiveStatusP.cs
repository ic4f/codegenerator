...
namespace Far.Data
{
	public class AccountTableGetUserLinksFoundationByActiveStatusP : c.AbstractDataTable
	{
		...
		#region constructor 
		public AccountTableGetUserLinksFoundationByActiveStatusP(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AccountRowGetUserLinksFoundationByActiveStatusP this[int row]
		public AccountRowGetUserLinksFoundationByActiveStatusP this[int row] { get { return (AccountRowGetUserLinksFoundationByActiveStatusP)Rows[row]; } }
		#endregion
	...
	public class AccountRowGetUserLinksFoundationByActiveStatusP : c.IDataRow
	{
		#region int Id
		public int Id
		{
