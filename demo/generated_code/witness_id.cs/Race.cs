...
namespace Wid.Data
{
	public class Race : Core.DataClass
	{
		#region constructor
		public Race(int recordId) : base()
		{
			loadRecord(recordId);
		}
		#endregion
		...
		public int Update()
		{
			SqlCommand command = new SqlCommand("a_Race_Update", Connection);
		...
		{
			SqlCommand command = new SqlCommand("a_Race_GetRecord", Connection);
			command.CommandType = CommandType.StoredProcedure;
