...
namespace Wid.Data
{
	public class Role : Core.DataClass
	{
		#region constructor
		...
		public int Update()
		{
			SqlCommand command = new SqlCommand("a_Role_Update", Connection);
		...
		{
			SqlCommand command = new SqlCommand("a_Role_GetRecord", Connection);
			command.CommandType = CommandType.StoredProcedure;
