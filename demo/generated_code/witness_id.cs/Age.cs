...
namespace Wid.Data
{
	public class Age : Core.DataClass
	{
		#region constructor
		public Age(int recordId) : base()
		{
			loadRecord(recordId);
		}
		#endregion
		...
		public int Update()
		{
			SqlCommand command = new SqlCommand("a_Age_Update", Connection);
		...
		{
			SqlCommand command = new SqlCommand("a_Age_GetRecord", Connection);
			command.CommandType = CommandType.StoredProcedure;
