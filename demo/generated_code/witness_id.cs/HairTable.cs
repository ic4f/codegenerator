...
namespace Wid.Data
{
	public class HairTable : c.AbstractDataTable
	{
		...
		#region constructor 
		public HairTable(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region HairRow this[int row]
		public HairRow this[int row] { get { return (HairRow)Rows[row]; } }
		#endregion
	...
	public class HairRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
