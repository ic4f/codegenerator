...
namespace Wid.Data
{
	public class AgeList : c.AbstractDataTable
	{
		...
		#region constructor 
		public AgeList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region AgeListRow this[int row]
		public AgeListRow this[int row] { get { return (AgeListRow)Rows[row]; } }
		#endregion
	...
	public class AgeListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
