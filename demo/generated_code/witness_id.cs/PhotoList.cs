...
namespace Wid.Data
{
	public class PhotoList : c.AbstractDataTable
	{
		...
		#region constructor 
		public PhotoList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region PhotoListRow this[int row]
		public PhotoListRow this[int row] { get { return (PhotoListRow)Rows[row]; } }
		#endregion
	...
	public class PhotoListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
