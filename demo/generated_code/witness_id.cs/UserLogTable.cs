...
namespace Wid.Data
{
	public class UserLogTable : c.AbstractDataTable
	{
		...
		#region constructor 
		public UserLogTable(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region UserLogRow this[int row]
		public UserLogRow this[int row] { get { return (UserLogRow)Rows[row]; } }
		#endregion
	...
	public class UserLogRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
