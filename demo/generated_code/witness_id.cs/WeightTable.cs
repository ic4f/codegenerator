...
namespace Wid.Data
{
	public class WeightTable : c.AbstractDataTable
	{
		...
		#region constructor 
		public WeightTable(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region WeightRow this[int row]
		public WeightRow this[int row] { get { return (WeightRow)Rows[row]; } }
		#endregion
	...
	public class WeightRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
