...
namespace Wid.Data
{
	public class RaceList : c.AbstractDataTable
	{
		...
		#region constructor 
		public RaceList(ArrayList rows, int totalCount) : base(rows, totalCount) {}
		#endregion
		...
		#region RaceListRow this[int row]
		public RaceListRow this[int row] { get { return (RaceListRow)Rows[row]; } }
		#endregion
		...
		private class IdFieldClass : c.IDataField
		{
			...
			public string SortExpression { get { return "Race.Id"; } }
	...
	public class RaceListRow : c.IDataRow
	{
		#region int Id
		public int Id
		{
