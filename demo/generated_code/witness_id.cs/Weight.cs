...
namespace Wid.Data
{
	public class Weight : Core.DataClass
	{
		#region constructor
		public Weight(int recordId) : base()
		{
			loadRecord(recordId);
		}
		#endregion
		...
		public int Update()
		{
			SqlCommand command = new SqlCommand("a_Weight_Update", Connection);
		...
		{
			SqlCommand command = new SqlCommand("a_Weight_GetRecord", Connection);
			command.CommandType = CommandType.StoredProcedure;
